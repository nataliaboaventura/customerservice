...
## Objetivo
O estudo tem como foco a análise dos chamados recebidos pelos canais de atendimento da empresa, identificando padrões, tempos de resolução e principais motivos de contato. A partir dessas métricas, é possível gerar insights para otimizar o atendimento e melhorar a eficiência do serviço.
...
2. Instale as dependências:
   ...
   ```
3. Execute o código Python em um ambiente como Jupyter Notebook ou diretamente no terminal.
...
## Contato
Dúvidas ou sugestões? Entr## Desenvolvimento de KPI’s do Serviço de Atendimento de uma Empresa Antifraude
...
---
e em contato comigo através do meu LinkedIn www.linkedin.com/in/natalia-boaventura
